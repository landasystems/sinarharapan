...
class CustomerController extends Controller
{
	...
	{        
                ...
                if(isset($_GET['Customer']))
		{
                       ...
                       if (!empty($model->kode)) $criteria->addCondition('kode = "'.$model->kode.'"');
                       ...
                       if (!empty($model->telepon)) $criteria->addCondition('telepon = "'.$model->telepon.'"');
                     
                    	
                       if (!empty($model->is_delete)) $criteria->addCondition('is_delete = "'.$model->is_delete.'"');
