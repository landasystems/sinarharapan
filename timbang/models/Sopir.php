 ...
 *
 * The followings are the available columns in table '{{sopir}}':
 * @property integer $id
 ...
 */
class Sopir extends CActiveRecord {
...
//        return app()->session['listPegawai'];
     ...
     * @return Sopir the static model class
     */
