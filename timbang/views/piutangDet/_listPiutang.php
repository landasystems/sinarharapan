...
//                    if ($val->total > $val->totalBayar) {
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="hidden" name="total_bayar[]" value="<?php echo $val->totalBayar ?>" class="total_bayar" id="total_bayar">
                        ...
                        <td width="20"><a href="#" class="btn btn-success"><span class="entypo-icon-history"></span></a></td>
                    </tr>
                    <?php
//                    }
                }
            ...
            <tfoot>
                <tr>
                    ...
                    <td colspan="2"><span class="total">Rp. 0</span></td>
                </tr>
            </tfoot>
        </table>
    </div>
