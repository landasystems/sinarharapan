...
$('.search-form form').submit(function(){
    $.fn.yiiGridView.update('sopir-grid', {
        data: $(this).serialize()
    });
    return false;
});
...
<?php
$button='';
if (landa()->checkAccess("sopir", 'r'))
    $button .= '{view} ';
if (landa()->checkAccess("sopir", 'u'))
    $button .= '{update} ';
if (landa()->checkAccess("sopir", 'd'))
...
//                    'label' => '',
                    ...
                    'url' => 'Yii::app()->createUrl("sopir/restore",array("id"=>$data->id))',
                    'options' => array(
